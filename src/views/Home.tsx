...
import { useGetProductsByFollowedStores } from '../hooks/useStoreFollowers';
...
export default function Home() {
    ...
    // 💡 دالة مساعدة لتنظيف وتجهيز مسار الصورة (للمتاجر والمنتجات معاً)
            ...
            <main className="container mx-auto px-6 py-16 space-y-20">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="h-64 bg-gray-50 relative overflow-hidden">
                                            <img
                                                src={product.image ? getImageUrl(product.image) : '/placeholder-product.png'}
                                                alt={product.name}
                ...
                <section>
                    ...
                    {isLoadingStores ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                            {storesData?.data?.map((store: any, index: any) => (
                                <div
                                    key={store.id}
                                ...
                                >
                                    <div>
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="w-14 h-14 bg-gray-50 rounded-xl border border-gray-100 p-1 shadow-sm overflow-hidden group-hover:scale-110 transition-transform duration-500">
                                                <img
                                                    src={store.logo ? getImageUrl(store.logo) : '/placeholder-store.png'}
                                                    alt={store.name}
                                    ...
                                    <div className="mt-6 pt-4 border-t border-gray-50 flex justify-between items-center opacity-80 group-hover:opacity-100 transition-opacity duration-300">
                                        ...
                                        <span className="text-xs font-bold text-moda-purple flex items-center gap-1 group-hover:gap-2 transition-all duration-300">
